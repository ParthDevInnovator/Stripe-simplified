...
import { getUserSubscriptions } from "../../../convex/subscription";
...
const ProPage = () => {
	...
	const isYearlySubscriptionActive = userSubscription?.status === "active" && getUserSubscriptions.planeType  === "year";
    const createProPlanCheckoutSession = useAction(api.stripe.createProPlanChekoutSession);
